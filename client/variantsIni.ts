...
gold = y
centaur = g
customPiece1 = w:FvW #warrior
customPiece2 = a:fR #lance with limited promotion
customPiece3 = i:R #rook with limit
customPiece4 = o:fN #horse with limited promotion
customPiece5 = u:N #knight with limit
customPiece6 = v:F #monk with limited promotion
customPiece7 = z:B #bishop with limit
customPiece8 = t:FfW #silver promoting to a gold
customPiece9 = f:FsfW
promotionLimit = i:1 u:1 z:1
promotionRank = 7
promotionPieceTypes = -
promotedPieceType = p:c m:b h:n l:r a:i o:u v:z t:y
mandatoryPiecePromotion = true
stalemateValue = loss
nFoldRule = 4
perpetualCheckIllegal = true
